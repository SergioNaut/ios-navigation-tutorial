...
#import "LetraRViewController.h"
#import <AVFoundation/AVFoundation.h>
#import "LetraSViewController.h"

@interface LetraRViewController ()

@end

@implementation LetraRViewController
...
{    [super viewDidLoad];
    ...
    AVSpeechUtterance *frase = [[AVSpeechUtterance alloc]initWithString:@"R de Rauts"];
...
-(void)printImage:(id)sender{
    ...
    UIImage *image = [UIImage imageNamed:@"ralts.png"];
