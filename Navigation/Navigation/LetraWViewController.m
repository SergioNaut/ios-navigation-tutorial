...
@interface LetraWViewController ()

@end

@implementation LetraWViewController
...
{    [super viewDidLoad];
    ...
    AVSpeechUtterance *frase = [[AVSpeechUtterance alloc]initWithString:@"W de Wobofét"];
...
-(void)next:(id)sender {
    LetraXViewController *proximo = [[LetraXViewController alloc]
                                     initWithNibName:nil
                                     bundle:NULL];
...
-(void)printImage:(id)sender{
    ...
    UIImage *image = [UIImage imageNamed:@"wobbuffet.png"];
