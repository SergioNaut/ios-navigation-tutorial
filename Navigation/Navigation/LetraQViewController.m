...
#import "LetraQViewController.h"
#import "LetraRViewController.h"
#import <AVFoundation/AVFoundation.h>
@interface LetraQViewController ()

@end

@implementation LetraQViewController
...
{    [super viewDidLoad];
    ...
    AVSpeechUtterance *frase = [[AVSpeechUtterance alloc]initWithString:@"Que de Quagzaier"];
...
-(void)next:(id)sender {
    LetraRViewController *proximo = [[LetraRViewController alloc]
                                     initWithNibName:nil
                                     bundle:NULL];
...
-(void)printImage:(id)sender{
    ...
    UIImage *image = [UIImage imageNamed:@"quagsire.png"];
