...
#import "LetraPViewController.h"
#import <AVFoundation/AVFoundation.h>
#import "LetraQViewController.h"
@interface LetraPViewController ()

@end

@implementation LetraPViewController
...
{    [super viewDidLoad];
    ...
    AVSpeechUtterance *frase = [[AVSpeechUtterance alloc]initWithString:@"P de Fãnfi"];
...
-(void)next:(id)sender {
    LetraQViewController *proximo = [[LetraQViewController alloc]
                                     initWithNibName:nil
                                     bundle:NULL];
...
-(void)printImage:(id)sender{
    ...
    UIImage *image = [UIImage imageNamed:@"phanpy.png"];
