...
@interface LetraMViewController ()

@end

@implementation LetraMViewController
...
{    [super viewDidLoad];
    ...
    AVSpeechUtterance *frase = [[AVSpeechUtterance alloc]initWithString:@"M de Mãdkip"];
...
-(void)next:(id)sender {
    LetraNViewController *proximo = [[LetraNViewController alloc]
                                     initWithNibName:nil
                                     bundle:NULL];
...
-(void)printImage:(id)sender{
    ...
    UIImage *image = [UIImage imageNamed:@"mudkip.png"];
